...
export class ProduitComponent implements OnInit {
  ...
  getDetailProduct(id_produit) {
    let self = this;
    self.globalProv.produit_detail(id_produit).subscribe(Data => {
      let Obj:any = [];
      Obj = Data;
        ...
        if(id_contact != null) {
          this.storage.get("panier").then((data) => {
              ...
              this.addNewItem({
                ...
                "quantite": 1,
                "attribut" : this.res.attribut,
                "id_produit_declinaison" : this.res.declinison_id
              });
