...
var FavPage = /** @class */ (function () {
    function FavPage(globalProv, superP, storage, nav, modalController) {
    ...
    FavPage.prototype.ngOnInit = function () {
    };
    FavPage.prototype.init = function () {
        var _this = this;
        var self = this;
        var obj = [];
    ...
    FavPage.prototype.gotoDetails = function (res) {
    ...
    FavPage.prototype.doRefresh = function (refresher) {
        var _this = this;
        setTimeout(function () {
            _this.init();
...
export { FavPage };
//# sourceMappingURL=fav.page.js.map